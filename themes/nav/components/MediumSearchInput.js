...
const SearchInput = ({ currentTag, currentSearch, cRef, className }) => {
  ...
  return <div className={'flex w-full bg-gray-100 ' + className}>
    ...
    placeholder='输入用户ID'
      ...
      className={'dark:bg-gray-50 outline-blue-500 w-full text-sm pl-2 transition focus:shadow-lg font-light leading-10 text-black'}
    ...
    <div className='-ml-8 cursor-pointer float-right items-center justify-center py-2'
      onClick={handleSearch}>
        ...
        <i className={`hover:text-black transform duration-200 text-gray-500  dark:hover:text-gray-300 cursor-pointer fas ${onLoading ? 'fa-spinner animate-spin' : 'fa-right-to-bracket text-xl'} `} />
