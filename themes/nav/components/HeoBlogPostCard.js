  ...
  return (
    <article
      ...
      <div
          ...
          <Link href={post?.href} passHref legacyBehavior>
            ...
            <div className='w-full md:w-5/12 2xl:w-full overflow-hidden'>
              <LazyImage
                ...
                alt={post?.title}
                className='w-full object-cover group-hover:scale-105 group-hover:brightness-75 transition-all duration-300'
              />
            </div>
          </Link>
        )}
        ...
        <div
          className={
            'flex p-1 2xl:p-1 flex-col justify-between h-14 md:h-full 2xl:h-14 w-full md:w-7/12 2xl:w-full'
          }>
          <header>
            {/* 分类 */}
            {/* {post?.category && (
