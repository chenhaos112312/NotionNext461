...
import BlogPostListPage from './components/HeoBlogPostListPage'
...
import SearchInput from './components/MediumSearchInput'
          ...
          <div
            ...
            <div className='main-menu z-20 pl-9 pr-7 pb-5 sticky pt-1 top-20 overflow-y-scroll h-fit max-h-full scroll-hidden bg-white dark:bg-neutral-800 rounded-xl '>
              ...
              <div className='grid pt-2'>
                {/* 显示菜单 */}
                {/* <SearchInput className='text-center w-3 mr-2 text-xs h-8' /> */}
                {links &&
